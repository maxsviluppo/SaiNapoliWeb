      ...
      <section className="py-16 max-w-4xl mx-auto px-6 text-slate-600 space-y-10 text-xs sm:text-sm leading-relaxed">
        ...
        <div className="bg-white p-6 rounded-xl border border-slate-200/60 shadow-sm space-y-4">
          ...
          <div className="space-y-2 text-slate-600 text-xs">
            <p><strong>Ragione Sociale:</strong> SALUTE, AMBIENTE, IGIENE s.r.l.</p>
            <p><strong>Sede Legale:</strong> Via Cesare Sersale 14/16 — Napoli (Italy)</p>
            <p><strong>P.IVA:</strong> 09851301219</p>
            <p><strong>Contatti:</strong> Tel: 081 06 08 910 | Cell: +39 393 88 79 849</p>
            <p><strong>Email:</strong> saluteambienteigiene@gmail.com | <strong>PEC:</strong> sai.srl@pecaruba.it</p>
